...
def banner():
    ...
    print GG+"  √=============================================√"
    print WW+"  |        MOD BY: NICOLEUS F Sitorus             |"
    print GL+"  |       Berdoa Dulu Sebelum Menggunakan       |"
    print WW+"  |            FACEBOOK: nico sitorus            |"
    print Y+"  |              WA:   082267052918              |"
    print GL+"  |---------------------------------------------|"
    print GL+"  |        LIFE OF PROGRAMMER [ N.I.C.O ]         |"
    print GL+"  |---------------------------------------------|"
    print GG+"  √=============================================√"
...
def main():
        ...
        life()
        print " "
        print RR+" wordlist tidak ada yg cocok Bro!!..."
        print " "
	

def iqbalz(nicoleus_password):
  try:
